package com.vastpro.onlineexamapplication.helper;
...
public class HibernateHelper {
	...
	/**
	 * Given the formBean T and a Group, this will invoke the Hibernate validator and will provide the set of ConstraintViolation objects
	 * 
	 * @param form
	 * @param clazz
	 * @return
