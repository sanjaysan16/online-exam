...
function Jj(a, b) {
  ...
  switch (b.tag) {
    ...
    case 3:
      return Jh(), E$1(Wf), E$1(H), Oh(), a = b.flags, 0 !== (a & 65536) && 0 === (a & 128) ? (b.flags = a & -65537 | 128, b) : null;
    case 5:
      return Lh(b), null;
    case 13:
      E$1(M);
...
const reactLogo = "/example/vite-react-app/assets/react-35ef61ed.svg";
const viteLogo = "/example/vite-react-app/vite.svg";
const App$1 = "";
var _function = {};
(function(exports) {
  ...
  var liftNullable = function(F2) {
    return function(f2, onNullable) {
      return function() {
        ...
        return F2.fromEither(o == null ? (0, exports.left)(onNullable.apply(void 0, a)) : (0, exports.right)(o));
      };
    };
  };
  ...
  var liftOption = function(F2) {
    return function(f2, onNone) {
      return function() {
        ...
        var o = f2.apply(void 0, a);
        return F2.fromEither((0, exports.isNone)(o) ? (0, exports.left)(onNone.apply(void 0, a)) : (0, exports.right)(o.value));
      };
    };
  };
  exports.liftOption = liftOption;
  var flatMapNullable = function(F2, M2) {
    return (0, function_12.dual)(3, function(self2, f2, onNullable) {
      return M2.flatMap(self2, (0, exports.liftNullable)(F2)(f2, onNullable));
    });
  };
  exports.flatMapNullable = flatMapNullable;
  var flatMapOption = function(F2, M2) {
    return (0, function_12.dual)(3, function(self2, f2, onNone) {
      return M2.flatMap(self2, (0, exports.liftOption)(F2)(f2, onNone));
    });
  };
  exports.flatMapOption = flatMapOption;
  var flatMapEither = function(F2, M2) {
    return (0, function_12.dual)(2, function(self2, f2) {
      return M2.flatMap(self2, function(a) {
...
function apS(F2) {
  return function(name, fb2) {
    return function(fa2) {
      return F2.ap(F2.map(fa2, function(a) {
        return function(b) {
          var _a;
...
function getFunctorComposition(F2, G2) {
  var _map = map$1(F2, G2);
  return {
    map: function(fga, f2) {
      return (0, function_1$7.pipe)(fga, _map(f2));
    }
  };
}
...
function getApplicativeMonoid(F2) {
  var f2 = (0, Apply_1$1.getApplySemigroup)(F2);
  return function(M2) {
    return {
      concat: f2(M2).concat,
...
function getApplicativeComposition(F2, G2) {
  var map2 = (0, Functor_1$3.getFunctorComposition)(F2, G2).map;
  var _ap = (0, Apply_1$1.ap)(F2, G2);
  return {
    map: map2,
    of: function(a) {
      return F2.of(G2.of(a));
    },
    ap: function(fgab, fga) {
      return (0, function_1$6.pipe)(fgab, _ap(fga));
    }
  };
}
...
function tap(M2) {
  return function(first, f2) {
    return M2.chain(first, function(a) {
      return M2.map(f2(a), function() {
        return a;
      });
    });
  };
...
function bind(M2) {
  return function(name, f2) {
    return function(ma2) {
      return M2.chain(ma2, function(a) {
        return M2.map(f2(a), function(b) {
          var _a;
          return Object.assign({}, a, (_a = {}, _a[name] = b, _a));
        });
      });
...
function fromPredicate(F2) {
  return function(predicate, onFalse) {
    return function(a) {
      return F2.fromEither(predicate(a) ? _$1.right(a) : _$1.left(onFalse(a)));
    };
  };
}
...
function fromOptionK(F2) {
  ...
  return function(onNone) {
    ...
    return function(f2) {
      return (0, function_1$5.flow)(f2, from);
    };
  };
}
...
function fromEitherK(F2) {
  return function(f2) {
    return (0, function_1$5.flow)(f2, F2.fromEither);
  };
}
...
(function(exports) {
  ...
  var function_12 = _function;
  var Functor_12 = Functor;
  var separated = function(left3, right3) {
    return { left: left3, right: right3 };
  };
  exports.separated = separated;
  var _map = function(fa2, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.map)(f2));
  };
  var _mapLeft = function(fa2, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.mapLeft)(f2));
  };
  var _bimap = function(fa2, g, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.bimap)(g, f2));
  };
  var map2 = function(f2) {
    return function(fa2) {
      return (0, exports.separated)((0, exports.left)(fa2), f2((0, exports.right)(fa2)));
    };
  };
  exports.map = map2;
  var mapLeft2 = function(f2) {
    return function(fa2) {
      return (0, exports.separated)(f2((0, exports.left)(fa2)), (0, exports.right)(fa2));
    };
  };
  exports.mapLeft = mapLeft2;
  var bimap2 = function(f2, g) {
    return function(fa2) {
      return (0, exports.separated)(f2((0, exports.left)(fa2)), g((0, exports.right)(fa2)));
    };
  };
    ...
    return function(predicate) {
      return function(ga) {
        return witherF(ga, function(a) {
          return F2.map(predicate(a), function(b) {
...
(function(exports) {
  ...
  var Apply_12 = Apply;
  var chainable = __importStar2(Chain);
  var ChainRec_1 = ChainRec;
  var FromEither_1 = FromEither;
  var function_12 = _function;
  var Functor_12 = Functor;
  var _2 = __importStar2(internal);
  var Separated_12 = Separated;
  var Witherable_1 = Witherable;
  exports.left = _2.left;
  exports.right = _2.right;
  exports.flatMap = (0, function_12.dual)(2, function(ma2, f2) {
    return (0, exports.isLeft)(ma2) ? ma2 : f2(ma2.right);
  });
  var _map = function(fa2, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.map)(f2));
  };
  var _ap = function(fab, fa2) {
    return (0, function_12.pipe)(fab, (0, exports.ap)(fa2));
  };
  var _reduce = function(fa2, b, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.reduce)(b, f2));
  };
  ...
  var _reduceRight = function(fa2, b, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.reduceRight)(b, f2));
  };
  ...
  var _bimap = function(fa2, f2, g) {
    return (0, function_12.pipe)(fa2, (0, exports.bimap)(f2, g));
  };
  var _mapLeft = function(fa2, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.mapLeft)(f2));
  };
  var _alt = function(fa2, that) {
    return (0, function_12.pipe)(fa2, (0, exports.alt)(that));
  };
  var _extend = function(wa2, f2) {
    return (0, function_12.pipe)(wa2, (0, exports.extend)(f2));
  };
  ...
  var getShow = function(SE, SA) {
    return {
      show: function(ma2) {
        return (0, exports.isLeft)(ma2) ? "left(".concat(SE.show(ma2.left), ")") : "right(".concat(SA.show(ma2.right), ")");
      }
    };
  };
  ...
  var getCompactable = function(M2) {
    ...
    return {
      ...
      compact: function(ma2) {
        return (0, exports.isLeft)(ma2) ? ma2 : ma2.right._tag === "None" ? empty : (0, exports.right)(ma2.right.value);
      },
      separate: function(ma2) {
        return (0, exports.isLeft)(ma2) ? (0, Separated_12.separated)(ma2, ma2) : (0, exports.isLeft)(ma2.right) ? (0, Separated_12.separated)((0, exports.right)(ma2.right.left), empty) : (0, Separated_12.separated)(empty, (0, exports.right)(ma2.right.right));
      }
    };
  };
  ...
  var getFilterable = function(M2) {
    var empty = (0, exports.left)(M2.empty);
    var _a = (0, exports.getCompactable)(M2), compact2 = _a.compact, separate2 = _a.separate;
    var filter2 = function(ma2, predicate) {
      return (0, exports.isLeft)(ma2) ? ma2 : predicate(ma2.right) ? ma2 : empty;
    };
    var partition2 = function(ma2, p2) {
      return (0, exports.isLeft)(ma2) ? (0, Separated_12.separated)(ma2, ma2) : p2(ma2.right) ? (0, Separated_12.separated)(empty, (0, exports.right)(ma2.right)) : (0, Separated_12.separated)((0, exports.right)(ma2.right), empty);
    };
    return {
      URI: exports.URI,
      _E: void 0,
      ...
      filterMap: function(ma2, f2) {
        if ((0, exports.isLeft)(ma2)) {
          return ma2;
        }
        var ob2 = f2(ma2.right);
        return ob2._tag === "None" ? empty : (0, exports.right)(ob2.value);
      },
      partition: partition2,
      partitionMap: function(ma2, f2) {
        if ((0, exports.isLeft)(ma2)) {
          return (0, Separated_12.separated)(ma2, ma2);
        }
        var e = f2(ma2.right);
        return (0, exports.isLeft)(e) ? (0, Separated_12.separated)((0, exports.right)(e.left), empty) : (0, Separated_12.separated)(empty, (0, exports.right)(e.right));
      }
    };
  };
  ...
  var getApplicativeValidation = function(SE) {
    return {
      ...
      map: _map,
      ap: function(fab, fa2) {
        return (0, exports.isLeft)(fab) ? (0, exports.isLeft)(fa2) ? (0, exports.left)(SE.concat(fab.left, fa2.left)) : fab : (0, exports.isLeft)(fa2) ? fa2 : (0, exports.right)(fab.right(fa2.right));
      },
      of: exports.of
    };
  };
  ...
  var getAltValidation = function(SE) {
    return {
      ...
      alt: function(me2, that) {
        if ((0, exports.isRight)(me2)) {
          return me2;
        }
        var ea2 = that();
        return (0, exports.isLeft)(ea2) ? (0, exports.left)(SE.concat(me2.left, ea2.left)) : ea2;
      }
    };
  };
  ...
  var map2 = function(f2) {
    return function(fa2) {
      return (0, exports.isLeft)(fa2) ? fa2 : (0, exports.right)(f2(fa2.right));
    };
  };
  exports.map = map2;
  exports.Functor = {
  ...
  exports.as = (0, function_12.dual)(2, (0, Functor_12.as)(exports.Functor));
  exports.asUnit = (0, Functor_12.asUnit)(exports.Functor);
  ...
  var apW = function(fa2) {
    return function(fab) {
      return (0, exports.isLeft)(fab) ? fab : (0, exports.isLeft)(fa2) ? fa2 : (0, exports.right)(fab.right(fa2.right));
    };
  };
  exports.apW = apW;
  ...
  var reduce = function(b, f2) {
    return function(fa2) {
      return (0, exports.isLeft)(fa2) ? b : f2(b, fa2.right);
    };
  };
  ...
  var foldMap = function(M2) {
    return function(f2) {
      return function(fa2) {
        return (0, exports.isLeft)(fa2) ? M2.empty : f2(fa2.right);
      };
    };
  };
  ...
  var reduceRight = function(b, f2) {
    return function(fa2) {
      return (0, exports.isLeft)(fa2) ? b : f2(fa2.right, b);
    };
  };
  ...
  var traverse = function(F2) {
    return function(f2) {
      return function(ta2) {
        return (0, exports.isLeft)(ta2) ? F2.of((0, exports.left)(ta2.left)) : F2.map(f2(ta2.right), exports.right);
      };
    };
  };
  ...
  var sequence = function(F2) {
    return function(ma2) {
      return (0, exports.isLeft)(ma2) ? F2.of((0, exports.left)(ma2.left)) : F2.map(ma2.right, exports.right);
    };
  };
  ...
  var bimap2 = function(f2, g) {
    return function(fa2) {
      return (0, exports.isLeft)(fa2) ? (0, exports.left)(f2(fa2.left)) : (0, exports.right)(g(fa2.right));
    };
  };
  exports.bimap = bimap2;
  var mapLeft2 = function(f2) {
    return function(fa2) {
      return (0, exports.isLeft)(fa2) ? (0, exports.left)(f2(fa2.left)) : fa2;
    };
  };
  exports.mapLeft = mapLeft2;
  exports.Bifunctor = {
  ...
  var altW = function(that) {
    return function(fa2) {
      return (0, exports.isLeft)(fa2) ? that() : fa2;
    };
  };
  exports.altW = altW;
  ...
  var extend = function(f2) {
    return function(wa2) {
      return (0, exports.isLeft)(wa2) ? wa2 : (0, exports.right)(f2(wa2));
    };
  };
  ...
  var matchW = function(onLeft, onRight) {
    return function(ma2) {
      return (0, exports.isLeft)(ma2) ? onLeft(ma2.left) : onRight(ma2.right);
    };
  };
  ...
  var getOrElseW = function(onLeft) {
    return function(ma2) {
      return (0, exports.isLeft)(ma2) ? onLeft(ma2.left) : ma2.right;
    };
  };
  ...
  exports.tap = (0, function_12.dual)(2, chainable.tap(exports.Chain));
  exports.flattenW = /* @__PURE__ */ (0, exports.flatMap)(function_12.identity);
  ...
  var swap2 = function(ma2) {
    return (0, exports.isLeft)(ma2) ? (0, exports.right)(ma2.left) : (0, exports.left)(ma2.right);
  };
  exports.swap = swap2;
  var orElseW = function(onLeft) {
    return function(ma2) {
      return (0, exports.isLeft)(ma2) ? onLeft(ma2.left) : ma2;
    };
  };
  ...
  function elem(E2) {
    return function(a, ma2) {
      if (ma2 === void 0) {
        var elemE_1 = elem(E2);
        return function(ma3) {
          return elemE_1(a, ma3);
        };
      }
      return (0, exports.isLeft)(ma2) ? false : E2.equals(a, ma2.right);
    };
  }
  exports.elem = elem;
  var exists = function(predicate) {
    return function(ma2) {
      return (0, exports.isLeft)(ma2) ? false : predicate(ma2.right);
    };
  };
  ...
  var traverseReadonlyArrayWithIndex = function(f2) {
    ...
    return function(as2) {
      return _2.isNonEmpty(as2) ? g(as2) : exports.ApT;
    };
  };
...
(function(exports) {
  ...
  var contramap_ = function(predicate, f2) {
    return (0, function_12.pipe)(predicate, (0, exports.contramap)(f2));
  };
  var contramap = function(f2) {
    return function(predicate) {
      return (0, function_12.flow)(f2, predicate);
    };
  };
  ...
  var getSemigroupAny = function() {
    return {
      concat: function(first, second) {
        return (0, function_12.pipe)(first, (0, exports.or)(second));
      }
    };
  };
  ...
  var getSemigroupAll = function() {
    return {
      concat: function(first, second) {
        return (0, function_12.pipe)(first, (0, exports.and)(second));
      }
    };
  };
...
var reverse = function(M2) {
  return {
    concat: function(first, second) {
      return M2.concat(second, first);
    }
  };
};
...
var filterFirst = function(predicate) {
  return function(M2) {
    return {
      concat: function(first, second) {
        return predicate(first) ? M2.concat(first, second) : second;
      }
    };
  };
};
...
var filterSecond = function(predicate) {
  return function(M2) {
    return {
      concat: function(first, second) {
        return predicate(second) ? M2.concat(first, second) : first;
      }
    };
  };
};
...
var endo = function(f2) {
  return function(M2) {
    return {
      concat: function(first, second) {
        return M2.concat(f2(first), f2(second));
      }
    };
  };
};
Magma.endo = endo;
var concatAll = function(M2) {
  return function(startWith) {
    return function(as2) {
      return as2.reduce(function(a, acc) {
        return M2.concat(a, acc);
      }, startWith);
    };
  };
};
...
(function(exports) {
  ...
  exports.tuple = tuple;
  var contramap_ = function(fa2, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.contramap)(f2));
  };
  var contramap = function(f2) {
    return function(fa2) {
      return (0, exports.fromEquals)(function(x2, y2) {
        return fa2.equals(f2(x2), f2(y2));
      });
    };
  };
  exports.contramap = contramap;
...
(function(exports) {
  ...
  var contramap = function(f2) {
    return function(fa2) {
      return (0, exports.fromCompare)(function(first, second) {
        return fa2.compare(f2(first), f2(second));
      });
    };
  };
  exports.contramap = contramap;
  ...
  var clamp = function(O2) {
    ...
    return function(low, hi2) {
      return function(a) {
        return maxO(minO(a, hi2), low);
      };
    };
  };
  exports.clamp = clamp;
  var between = function(O2) {
    ...
    return function(low, hi2) {
      return function(a) {
        return ltO(a, low) || gtO(a, hi2) ? false : true;
      };
    };
  };
...
(function(exports) {
  ...
  exports.last = last;
  exports.concatAll = M2.concatAll;
...
(function(exports) {
  ...
  var getLeft = function(ma2) {
    return ma2._tag === "Right" ? exports.none : (0, exports.some)(ma2.left);
  };
  exports.getLeft = getLeft;
  var getRight = function(ma2) {
    return ma2._tag === "Left" ? exports.none : (0, exports.some)(ma2.right);
  };
  ...
  var _filter = function(fa2, predicate) {
    return (0, function_12.pipe)(fa2, (0, exports.filter)(predicate));
  };
  var _filterMap = function(fa2, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.filterMap)(f2));
  };
  var _extend = function(wa2, f2) {
    return (0, function_12.pipe)(wa2, (0, exports.extend)(f2));
  };
  var _partition = function(fa2, predicate) {
    return (0, function_12.pipe)(fa2, (0, exports.partition)(predicate));
  };
  var _partitionMap = function(fa2, f2) {
    return (0, function_12.pipe)(fa2, (0, exports.partitionMap)(f2));
  };
  exports.URI = "Option";
  var getShow = function(S2) {
    return {
      show: function(ma2) {
        return (0, exports.isNone)(ma2) ? "none" : "some(".concat(S2.show(ma2.value), ")");
      }
    };
  };
  exports.getShow = getShow;
  var getEq = function(E2) {
    return {
      equals: function(x2, y2) {
        return x2 === y2 || ((0, exports.isNone)(x2) ? (0, exports.isNone)(y2) : (0, exports.isNone)(y2) ? false : E2.equals(x2.value, y2.value));
      }
    };
  };
  exports.getEq = getEq;
  var getOrd = function(O2) {
    return {
      ...
      compare: function(x2, y2) {
        return x2 === y2 ? 0 : (0, exports.isSome)(x2) ? (0, exports.isSome)(y2) ? O2.compare(x2.value, y2.value) : 1 : -1;
      }
    };
  };
  ...
  var map2 = function(f2) {
    return function(fa2) {
      return (0, exports.isNone)(fa2) ? exports.none : (0, exports.some)(f2(fa2.value));
    };
  };
  exports.map = map2;
  exports.Functor = {
  ...
  var ap2 = function(fa2) {
    return function(fab) {
      return (0, exports.isNone)(fab) ? exports.none : (0, exports.isNone)(fa2) ? exports.none : (0, exports.some)(fab.value(fa2.value));
    };
  };
  exports.ap = ap2;
  exports.Apply = {
  ...
  exports.flatMap = (0, function_12.dual)(2, function(ma2, f2) {
    return (0, exports.isNone)(ma2) ? exports.none : f2(ma2.value);
  });
  exports.Chain = {
    URI: exports.URI,
    map: _map,
  ...
  var reduce = function(b, f2) {
    return function(fa2) {
      return (0, exports.isNone)(fa2) ? b : f2(b, fa2.value);
    };
  };
  exports.reduce = reduce;
  var foldMap = function(M2) {
    return function(f2) {
      return function(fa2) {
        return (0, exports.isNone)(fa2) ? M2.empty : f2(fa2.value);
      };
    };
  };
  exports.foldMap = foldMap;
  var reduceRight = function(b, f2) {
    return function(fa2) {
      return (0, exports.isNone)(fa2) ? b : f2(fa2.value, b);
    };
  };
  exports.reduceRight = reduceRight;
  exports.Foldable = {
  ...
  exports.orElse = (0, function_12.dual)(2, function(self2, that) {
  ...
  var extend = function(f2) {
    return function(wa2) {
      return (0, exports.isNone)(wa2) ? exports.none : (0, exports.some)(f2(wa2));
    };
  };
  exports.extend = extend;
  exports.Extend = {
  ...
  exports.compact = (0, exports.flatMap)(function_12.identity);
  var defaultSeparated = /* @__PURE__ */ (0, Separated_12.separated)(exports.none, exports.none);
  var separate2 = function(ma2) {
    return (0, exports.isNone)(ma2) ? defaultSeparated : (0, Separated_12.separated)((0, exports.getLeft)(ma2.value), (0, exports.getRight)(ma2.value));
  };
  exports.separate = separate2;
  exports.Compactable = {
    URI: exports.URI,
  ...
  var filter2 = function(predicate) {
    return function(fa2) {
      return (0, exports.isNone)(fa2) ? exports.none : predicate(fa2.value) ? fa2 : exports.none;
    };
  };
  exports.filter = filter2;
  var filterMap2 = function(f2) {
    return function(fa2) {
      return (0, exports.isNone)(fa2) ? exports.none : f2(fa2.value);
    };
  };
  exports.filterMap = filterMap2;
  var partition2 = function(predicate) {
    return function(fa2) {
      return (0, Separated_12.separated)(_filter(fa2, (0, Predicate_12.not)(predicate)), _filter(fa2, predicate));
    };
  };
  exports.partition = partition2;
  var partitionMap2 = function(f2) {
    return (0, function_12.flow)((0, exports.map)(f2), exports.separate);
  };
  exports.partitionMap = partitionMap2;
  exports.Filterable = {
    URI: exports.URI,
    map: _map,
    compact: exports.compact,
  ...
  var traverse = function(F2) {
    return function(f2) {
      return function(ta2) {
        return (0, exports.isNone)(ta2) ? F2.of(exports.none) : F2.map(f2(ta2.value), exports.some);
      };
    };
  };
  exports.traverse = traverse;
  var sequence = function(F2) {
    return function(ta2) {
      return (0, exports.isNone)(ta2) ? F2.of(exports.none) : F2.map(ta2.value, exports.some);
    };
  };
  exports.sequence = sequence;
  exports.Traversable = {
  ...
  var matchW = function(onNone, onSome) {
    return function(ma2) {
      return (0, exports.isNone)(ma2) ? onNone() : onSome(ma2.value);
    };
  };
  exports.matchW = matchW;
  exports.foldW = exports.matchW;
  ...
  var getOrElseW = function(onNone) {
    return function(ma2) {
      return (0, exports.isNone)(ma2) ? onNone() : ma2.value;
    };
  };
  exports.getOrElseW = getOrElseW;
  exports.getOrElse = exports.getOrElseW;
  ...
  exports.tap = (0, function_12.dual)(2, chainable.tap(exports.Chain));
  exports.tapEither = (0, function_12.dual)(2, (0, FromEither_1.tapEither)(exports.FromEither, exports.Chain));
  exports.duplicate = (0, exports.extend)(function_12.identity);
  ...
  var fromNullableK2 = function(f2) {
    return (0, function_12.flow)(f2, exports.fromNullable);
  };
  exports.fromNullableK = fromNullableK2;
  var chainNullableK2 = function(f2) {
    return function(ma2) {
      return (0, exports.isNone)(ma2) ? exports.none : (0, exports.fromNullable)(f2(ma2.value));
    };
  };
  exports.chainNullableK = chainNullableK2;
  exports.toNullable = (0, exports.match)(function_12.constNull, function_12.identity);
  exports.toUndefined = (0, exports.match)(function_12.constUndefined, function_12.identity);
  function elem(E2) {
    return function(a, ma2) {
      if (ma2 === void 0) {
        var elemE_1 = elem(E2);
      ...
      return (0, exports.isNone)(ma2) ? false : E2.equals(a, ma2.value);
    };
  }
  exports.elem = elem;
  var exists = function(predicate) {
    return function(ma2) {
      return (0, exports.isNone)(ma2) ? false : predicate(ma2.value);
    };
  };
  exports.exists = exists;
  exports.Do = (0, exports.of)(_2.emptyRecord);
  ...
  exports.getApplySemigroup = (0, Apply_12.getApplySemigroup)(exports.Apply);
...
function compact(F2, G2) {
  return function(fga) {
    return F2.map(fga, G2.compact);
  };
}
Compactable.compact = compact;
function separate(F2, C2, G2) {
  var _compact = compact(F2, C2);
  var _map = (0, Functor_1$2.map)(F2, G2);
  return function(fge) {
    return S.separated(_compact((0, function_1$4.pipe)(fge, _map(Option_1$1.getLeft))), _compact((0, function_1$4.pipe)(fge, _map(Option_1$1.getRight))));
  };
}
Compactable.separate = separate;
function getCompactableComposition(F2, G2) {
  var map2 = (0, Functor_1$2.getFunctorComposition)(F2, G2).map;
  return {
    map: map2,
    compact: compact(F2, G2),
    separate: separate(F2, G2, G2)
  };
}
...
function right(F2) {
  return (0, function_1$3.flow)(E.right, F2.of);
}
EitherT.right = right;
function left(F2) {
  return (0, function_1$3.flow)(E.left, F2.of);
}
EitherT.left = left;
function rightF(F2) {
  return function(fa2) {
    return F2.map(fa2, E.right);
  };
}
EitherT.rightF = rightF;
function leftF(F2) {
  return function(fe2) {
    return F2.map(fe2, E.left);
  };
}
EitherT.leftF = leftF;
function fromNullable(F2) {
  return function(e) {
    return (0, function_1$3.flow)(E.fromNullable(e), F2.of);
  };
}
EitherT.fromNullable = fromNullable;
function fromNullableK(F2) {
  var fromNullableF = fromNullable(F2);
  return function(e) {
    var fromNullableFE = fromNullableF(e);
    return function(f2) {
      return (0, function_1$3.flow)(f2, fromNullableFE);
    };
  };
}
EitherT.fromNullableK = fromNullableK;
function chainNullableK(M2) {
  var chainM = chain(M2);
  var fromNullableKM = fromNullableK(M2);
  return function(e) {
...
function map(F2) {
  return (0, Functor_1$1.map)(F2, E.Functor);
}
EitherT.map = map;
function ap(F2) {
  return (0, Apply_1.ap)(F2, E.Apply);
}
EitherT.ap = ap;
function chain(M2) {
  var flatMapM = flatMap(M2);
  return function(f2) {
    return function(ma2) {
      return flatMapM(ma2, f2);
    };
  };
}
EitherT.chain = chain;
function flatMap(M2) {
  return function(ma2, f2) {
    return M2.chain(ma2, function(e) {
      return E.isLeft(e) ? M2.of(e) : f2(e.right);
    });
  };
}
  ...
  return function(second) {
    return function(first) {
      return M2.chain(first, function(e) {
        return E.isLeft(e) ? second() : M2.of(e);
      });
    };
  };
}
EitherT.alt = alt;
function bimap(F2) {
  var mapBothF = mapBoth(F2);
  return function(f2, g) {
    return function(self2) {
      return mapBothF(self2, f2, g);
    };
  };
}
EitherT.bimap = bimap;
function mapBoth(F2) {
  return function(self2, f2, g) {
    return F2.map(self2, E.bimap(f2, g));
  };
}
EitherT.mapBoth = mapBoth;
function mapLeft(F2) {
  var mapErrorF = mapError(F2);
  return function(f2) {
    return function(self2) {
      return mapErrorF(self2, f2);
    };
  };
}
...
function mapError(F2) {
  return function(self2, f2) {
    return F2.map(self2, E.mapLeft(f2));
  };
}
...
function altValidation(M2, S2) {
  return function(second) {
    return function(first) {
      return M2.chain(first, E.match(function(e1) {
        return M2.map(second(), E.mapLeft(function(e2) {
...
function match(F2) {
  return function(onLeft, onRight) {
    return function(ma2) {
      return F2.map(ma2, E.match(onLeft, onRight));
    };
  };
}
EitherT.match = match;
function matchE(M2) {
  return function(onLeft, onRight) {
    return function(ma2) {
      return M2.chain(ma2, E.match(onLeft, onRight));
    };
  };
}
EitherT.matchE = matchE;
function getOrElse(M2) {
  return function(onLeft) {
    return function(ma2) {
      return M2.chain(ma2, E.match(onLeft, M2.of));
    };
  };
}
...
function orElse(M2) {
  return function(onLeft) {
    return function(ma2) {
      return M2.chain(ma2, function(e) {
        return E.isLeft(e) ? onLeft(e.left) : M2.of(e);
      });
    };
  };
}
...
function orElseFirst(M2) {
  var tapErrorM = tapError(M2);
  return function(onLeft) {
    return function(ma2) {
      return tapErrorM(ma2, onLeft);
    };
  };
}
EitherT.orElseFirst = orElseFirst;
function tapError(M2) {
  var orElseM = orElse(M2);
  return function(ma2, onLeft) {
    return (0, function_1$3.pipe)(ma2, orElseM(function(e) {
      return M2.map(onLeft(e), function(eb2) {
        return E.isLeft(eb2) ? eb2 : E.left(e);
      });
    }));
  };
}
...
function orLeft(M2) {
  return function(onLeft) {
    return function(ma2) {
      return M2.chain(ma2, E.match(function(e) {
        return M2.map(onLeft(e), E.left);
      }, function(a) {
        return M2.of(E.right(a));
      }));
    };
  };
}
...
function swap(F2) {
  return function(ma2) {
    return F2.map(ma2, E.swap);
  };
}
EitherT.swap = swap;
function toUnion(F2) {
  return function(fa2) {
    return F2.map(fa2, E.toUnion);
  };
}
EitherT.toUnion = toUnion;
function getEitherM(M2) {
  var _ap = ap(M2);
  var _map = map(M2);
  var _chain = chain(M2);
  var _alt = alt(M2);
  var _bimap = bimap(M2);
  var _mapLeft = mapLeft(M2);
  var _fold = matchE(M2);
  var _getOrElse = getOrElse(M2);
  var _orElse = orElse(M2);
  return {
    map: function(fa2, f2) {
      return (0, function_1$3.pipe)(fa2, _map(f2));
    },
    ap: function(fab, fa2) {
      return (0, function_1$3.pipe)(fab, _ap(fa2));
    },
    of: right(M2),
    chain: function(ma2, f2) {
      return (0, function_1$3.pipe)(ma2, _chain(f2));
    },
    alt: function(fa2, that) {
      return (0, function_1$3.pipe)(fa2, _alt(that));
    },
    bimap: function(fea, f2, g) {
      return (0, function_1$3.pipe)(fea, _bimap(f2, g));
    },
    mapLeft: function(fea, f2) {
      return (0, function_1$3.pipe)(fea, _mapLeft(f2));
    },
    fold: function(fa2, onLeft, onRight) {
      return (0, function_1$3.pipe)(fa2, _fold(onLeft, onRight));
    },
    getOrElse: function(fa2, onLeft) {
      return (0, function_1$3.pipe)(fa2, _getOrElse(onLeft));
    },
    orElse: function(fa2, f2) {
      return (0, function_1$3.pipe)(fa2, _orElse(f2));
    },
    swap: swap(M2),
    rightM: rightF(M2),
    leftM: leftF(M2),
...
function partition(F2, G2) {
  var _filter = filter(F2, G2);
  return function(predicate) {
    var left2 = _filter((0, Predicate_1.not)(predicate));
    var right2 = _filter(predicate);
    return function(fgb) {
      return (0, Separated_1.separated)(left2(fgb), right2(fgb));
    };
  };
}
Filterable.partition = partition;
function partitionMap(F2, G2) {
  var _filterMap = filterMap(F2, G2);
  return function(f2) {
    return function(fga) {
      return (0, Separated_1.separated)((0, function_1$2.pipe)(fga, _filterMap(function(a) {
        return (0, Option_1.getLeft)(f2(a));
      })), (0, function_1$2.pipe)(fga, _filterMap(function(a) {
...
function getFilterableComposition(F2, G2) {
  var map2 = (0, Functor_1.getFunctorComposition)(F2, G2).map;
  var _compact = (0, Compactable_1.compact)(F2, G2);
  var _separate = (0, Compactable_1.separate)(F2, G2, G2);
  var _filter = filter(F2, G2);
  var _filterMap = filterMap(F2, G2);
  var _partition = partition(F2, G2);
  var _partitionMap = partitionMap(F2, G2);
  return {
    map: map2,
    compact: _compact,
    separate: _separate,
    filter: function(fga, f2) {
      return (0, function_1$2.pipe)(fga, _filter(f2));
    },
    filterMap: function(fga, f2) {
      return (0, function_1$2.pipe)(fga, _filterMap(f2));
    },
    partition: function(fga, p2) {
      return (0, function_1$2.pipe)(fga, _partition(p2));
    },
    partitionMap: function(fga, f2) {
      return (0, function_1$2.pipe)(fga, _partitionMap(f2));
    }
  };
}
...
function fromIOK(F2) {
  return function(f2) {
    return (0, function_1$1.flow)(f2, F2.fromIO);
  };
}
FromIO.fromIOK = fromIOK;
function chainIOK(F2, M2) {
  return function(f2) {
    var g = (0, function_1$1.flow)(f2, F2.fromIO);
    return function(first) {
      return M2.chain(first, g);
    };
  };
}
FromIO.chainIOK = chainIOK;
function chainFirstIOK(F2, M2) {
  var tapIOM = tapIO(F2, M2);
  return function(f2) {
    return function(first) {
...
function tapIO(F2, M2) {
  var chainFirstM = (0, Chain_1$1.tap)(M2);
  return function(self2, f2) {
    return chainFirstM(self2, (0, function_1$1.flow)(f2, F2.fromIO));
  };
}
FromIO.tapIO = tapIO;
var FromTask = {};
...
function fromTaskK(F2) {
  return function(f2) {
    return (0, function_1.flow)(f2, F2.fromTask);
  };
}
FromTask.fromTaskK = fromTaskK;
function chainTaskK(F2, M2) {
  return function(f2) {
    var g = (0, function_1.flow)(f2, F2.fromTask);
    return function(first) {
      return M2.chain(first, g);
    };
  };
...
function tapTask(F2, M2) {
  var tapM = (0, Chain_1.tap)(M2);
  return function(self2, f2) {
    return tapM(self2, (0, function_1.flow)(f2, F2.fromTask));
  };
}
...
(function(exports) {
    ...
    return function(ma2) {
      return function() {
        return new Promise(function(resolve) {
          setTimeout(function() {
            Promise.resolve().then(ma2).then(resolve);
          }, millis);
        });
      };
    };
  ...
  var map2 = function(f2) {
    return function(fa2) {
      return function() {
        return Promise.resolve().then(fa2).then(f2);
      };
    };
  };
  exports.map = map2;
  var ap2 = function(fa2) {
    return function(fab) {
      return function() {
        return Promise.all([Promise.resolve().then(fab), Promise.resolve().then(fa2)]).then(function(_a) {
          var f2 = _a[0], a = _a[1];
          return f2(a);
        });
      };
  ...
  exports.flatMap = (0, function_12.dual)(2, function(ma2, f2) {
    return function() {
      return Promise.resolve().then(ma2).then(function(a) {
        return f2(a)();
      });
    };
  });
  ...
  exports.apFirst = (0, Apply_12.apFirst)(exports.ApplyPar);
  exports.apSecond = (0, Apply_12.apSecond)(exports.ApplyPar);
  ...
  exports.fromTask = function_12.identity;
  exports.MonadTask = {
    URI: exports.URI,
    map: _map,
    of: exports.of,
  ...
  exports.tap = (0, function_12.dual)(2, chainable.tap(exports.Chain));
  exports.tapIO = (0, function_12.dual)(2, (0, FromIO_1.tapIO)(exports.FromIO, exports.Chain));
  ...
  exports.let = let_2;
  exports.bind = chainable.bind(exports.Chain);
  exports.apS = (0, Apply_12.apS)(exports.ApplyPar);
  exports.ApT = (0, exports.of)(_2.emptyReadonlyArray);
  var traverseReadonlyNonEmptyArrayWithIndex = function(f2) {
    return function(as2) {
      return function() {
        return Promise.all(as2.map(function(a, i) {
  ...
  var traverseReadonlyNonEmptyArrayWithIndexSeq = function(f2) {
    return function(as2) {
      return function() {
        return _2.tail(as2).reduce(function(acc, a, i) {
        ...
        }, Promise.resolve().then(f2(0, _2.head(as2))).then(_2.singleton));
      };
    };
  };
  ...
  exports.sequenceSeqArray = /* @__PURE__ */ (0, exports.traverseSeqArray)(function_12.identity);
  exports.chain = exports.flatMap;
  exports.chainFirst = exports.tap;
  exports.task = {
    URI: exports.URI,
  ...
  exports.getSemigroup = (0, Apply_12.getApplySemigroup)(exports.ApplySeq);
...
(function(exports) {
  ...
  var Apply_12 = Apply;
  var chainable = __importStar2(Chain);
  var Compactable_12 = Compactable;
  var E2 = __importStar2(Either);
  var ET = __importStar2(EitherT);
  ...
  var Functor_12 = Functor;
  var _2 = __importStar2(internal);
  var T2 = __importStar2(Task);
  exports.left = ET.left(T2.Pointed);
  exports.right = ET.right(T2.Pointed);
  exports.rightTask = ET.rightF(T2.Functor);
  exports.leftTask = ET.leftF(T2.Functor);
  exports.rightIO = (0, function_12.flow)(T2.fromIO, exports.rightTask);
  exports.leftIO = (0, function_12.flow)(T2.fromIO, exports.leftTask);
  exports.fromIO = exports.rightIO;
  exports.fromTask = exports.rightTask;
  exports.fromEither = T2.of;
  exports.fromIOEither = T2.fromIO;
  var fromTaskOption = function(onNone) {
    return T2.map(E2.fromOption(onNone));
  };
  exports.fromTaskOption = fromTaskOption;
  exports.match = /* @__PURE__ */ ET.match(T2.Functor);
  exports.matchW = exports.match;
  exports.matchE = ET.matchE(T2.Monad);
  exports.fold = exports.matchE;
  exports.matchEW = exports.matchE;
  exports.foldW = exports.matchEW;
  exports.getOrElse = /* @__PURE__ */ ET.getOrElse(T2.Monad);
  ...
  exports.tryCatchK = tryCatchK;
  exports.toUnion = ET.toUnion(T2.Functor);
  exports.fromNullable = ET.fromNullable(T2.Pointed);
  exports.fromNullableK = ET.fromNullableK(T2.Pointed);
  exports.chainNullableK = /* @__PURE__ */ ET.chainNullableK(T2.Monad);
  exports.orElse = /* @__PURE__ */ ET.orElse(T2.Monad);
  exports.orElseW = exports.orElse;
  exports.tapError = (0, function_12.dual)(2, ET.tapError(T2.Monad));
  ...
  exports.orLeft = /* @__PURE__ */ ET.orLeft(T2.Monad);
  exports.swap = ET.swap(T2.Functor);
  ...
  var chainTaskOptionKW = function(onNone) {
    return function(f2) {
      return function(ma2) {
        return (0, exports.flatMap)(ma2, (0, exports.fromTaskOptionK)(onNone)(f2));
      };
    };
  };
  ...
  var fromIOEitherK = function(f2) {
    return (0, function_12.flow)(f2, exports.fromIOEither);
  };
  ...
  exports.map = ET.map(T2.Functor);
  exports.mapBoth = (0, function_12.dual)(3, ET.mapBoth(T2.Functor));
  exports.bimap = exports.mapBoth;
  exports.mapError = (0, function_12.dual)(2, ET.mapError(T2.Functor));
  exports.mapLeft = exports.mapError;
  exports.ap = /* @__PURE__ */ ET.ap(T2.ApplyPar);
  exports.apW = exports.ap;
  exports.flatMap = (0, function_12.dual)(2, ET.flatMap(T2.Monad));
  exports.flattenW = /* @__PURE__ */ (0, exports.flatMap)(function_12.identity);
  exports.flatten = exports.flattenW;
  exports.alt = /* @__PURE__ */ ET.alt(T2.Monad);
  exports.altW = exports.alt;
  exports.of = exports.right;
  exports.throwError = exports.left;
  exports.URI = "TaskEither";
  function getApplicativeTaskValidation(A2, S2) {
    var ap2 = (0, Apply_12.ap)(A2, E2.getApplicativeValidation(S2));
    return {
      URI: exports.URI,
      _E: void 0,
      map: _map,
      ap: function(fab, fa2) {
        return (0, function_12.pipe)(fab, ap2(fa2));
      },
      of: exports.of
    };
  }
  ...
  function getAltTaskValidation(S2) {
    var alt2 = ET.altValidation(T2.Monad, S2);
    return {
      URI: exports.URI,
      _E: void 0,
      map: _map,
      alt: function(fa2, that) {
        return (0, function_12.pipe)(fa2, alt2(that));
      }
    };
  }
  exports.getAltTaskValidation = getAltTaskValidation;
  var getCompactable = function(M2) {
    var C2 = E2.getCompactable(M2);
    return {
      URI: exports.URI,
      _E: void 0,
      compact: (0, Compactable_12.compact)(T2.Functor, C2),
      separate: (0, Compactable_12.separate)(T2.Functor, C2, E2.Functor)
    };
  };
  exports.getCompactable = getCompactable;
  function getFilterable(M2) {
    var F2 = E2.getFilterable(M2);
    var C2 = (0, exports.getCompactable)(M2);
    var filter2 = (0, Filterable_1.filter)(T2.Functor, F2);
    var filterMap2 = (0, Filterable_1.filterMap)(T2.Functor, F2);
    var partition2 = (0, Filterable_1.partition)(T2.Functor, F2);
    var partitionMap2 = (0, Filterable_1.partitionMap)(T2.Functor, F2);
    return {
      URI: exports.URI,
      _E: void 0,
      map: _map,
      ...
      filter: function(fa2, predicate) {
        return (0, function_12.pipe)(fa2, filter2(predicate));
      },
      filterMap: function(fa2, f2) {
        return (0, function_12.pipe)(fa2, filterMap2(f2));
      },
      partition: function(fa2, predicate) {
        return (0, function_12.pipe)(fa2, partition2(predicate));
      },
      partitionMap: function(fa2, f2) {
        return (0, function_12.pipe)(fa2, partitionMap2(f2));
      }
    };
  }
  exports.getFilterable = getFilterable;
  ...
  exports.tapEither = (0, function_12.dual)(2, (0, FromEither_1.tapEither)(exports.FromEither, exports.Chain));
  exports.tapIO = (0, function_12.dual)(2, (0, FromIO_1.tapIO)(exports.FromIO, exports.Chain));
  exports.tapTask = (0, function_12.dual)(2, (0, FromTask_1.tapTask)(exports.FromTask, exports.Chain));
  exports.Bifunctor = {
    URI: exports.URI,
  ...
  exports.flatMapIOEither = (0, function_12.dual)(2, function(self2, f2) {
    return (0, exports.flatMap)(self2, (0, exports.fromIOEitherK)(f2));
  });
  exports.flatMapTaskOption = (0, function_12.dual)(3, function(self2, f2, onNone) {
      ...
      return function() {
        return new Promise(function(resolve) {
          var cbResolver = function(e, r2) {
            return e != null ? resolve(_2.left(e)) : resolve(_2.right(r2));
          };
  ...
  var bracketW = function(acquire, use, release) {
    return (0, exports.flatMap)(acquire, function(a) {
      return T2.flatMap(use(a), function(e) {
  ...
  exports.ApT = (0, exports.of)(_2.emptyReadonlyArray);
  var traverseReadonlyNonEmptyArrayWithIndex = function(f2) {
    return (0, function_12.flow)(T2.traverseReadonlyNonEmptyArrayWithIndex(f2), T2.map(E2.traverseReadonlyNonEmptyArrayWithIndex(function_12.SK)));
  };
  exports.traverseReadonlyNonEmptyArrayWithIndex = traverseReadonlyNonEmptyArrayWithIndex;
  var traverseReadonlyArrayWithIndex = function(f2) {
    var g = (0, exports.traverseReadonlyNonEmptyArrayWithIndex)(f2);
      ...
      return function() {
        return _2.tail(as2).reduce(function(acc, a, i) {
          return acc.then(function(ebs) {
            return _2.isLeft(ebs) ? acc : f2(i + 1, a)().then(function(eb2) {
              if (_2.isLeft(eb2)) {
                return eb2;
              }
              ebs.right.push(eb2.right);
              return ebs;
            });
          });
        }, f2(0, _2.head(as2))().then(E2.map(_2.singleton)));
      };
    };
  };
  exports.traverseReadonlyNonEmptyArrayWithIndexSeq = traverseReadonlyNonEmptyArrayWithIndexSeq;
  ...
  exports.getApplySemigroup = /* @__PURE__ */ (0, Apply_12.getApplySemigroup)(exports.ApplySeq);
  exports.getApplyMonoid = /* @__PURE__ */ (0, Applicative_1.getApplicativeMonoid)(exports.ApplicativeSeq);
  var getSemigroup = function(S2) {
    return (0, Apply_12.getApplySemigroup)(T2.ApplySeq)(E2.getSemigroup(S2));
  };
  exports.getSemigroup = getSemigroup;
  function getTaskValidation(SE) {
    var applicativeTaskValidation = getApplicativeTaskValidation(T2.ApplicativePar, SE);
...
const ApiContextProvider = ({ children }) => {
  const [apiKey] = reactExports.useState(
    () => document ? document.getElementById("ofbizRestApiToken").value : "MISSING_API_KEY"
  );
  ...
  return /* @__PURE__ */ jsx(ApiContext.Provider, { value: { get }, children });
};
const useApi = () => reactExports.useContext(ApiContext);
function App() {
  const { get: apiGet } = useApi();
  const [count, setCount] = reactExports.useState(0);
  const [apiPath, setApiPath] = reactExports.useState("/services");
  const [apiResults, setApiResults] = reactExports.useState("Not yet called");
  const apiButtonClickHandler = reactExports.useCallback(() => {
    setApiResults("Calling API...");
    const apiCallAsTaskEither = _function.pipe(apiGet(apiPath));
    apiCallAsTaskEither().then((result) => {
      if (Either.isLeft(result)) {
        return "Error: " + result.left.message;
      } else {
        return result.right.text();
      }
    }).then((result) => setApiResults(result)).catch((err) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "App", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsx("p", { children: "Enter path and click button to call API with GET" }),
      /* @__PURE__ */ jsx("input", { value: apiPath, onChange: (e) => setApiPath(e.target.value) }),
      /* @__PURE__ */ jsx("button", { onClick: () => apiButtonClickHandler(), children: "Call API" }),
      /* @__PURE__ */ jsx("h1", { children: "API results" }),
      /* @__PURE__ */ jsx("pre", { children: apiResults }),
      /* @__PURE__ */ jsx("h2", { children: "Example API paths" }),
      /* @__PURE__ */ jsx("p", { children: "/services" }),
      /* @__PURE__ */ jsx("p", { children: "/services/findProductById?inParams=%7B%22idToFind%22:%22GZ-1001%22%7D" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsx("p", { children: "Click this button to see the counter increment" }),
...
const index = "";
client.createRoot(
  document.getElementById("ReactExamplesRootContainer")
).render(
  /* @__PURE__ */ jsx(React.StrictMode, { children: /* @__PURE__ */ jsx(ApiContextProvider, { children: /* @__PURE__ */ jsx(App, {}) }) })
);
